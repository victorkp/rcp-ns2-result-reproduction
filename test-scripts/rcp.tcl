...
if {$argc != 11} {
    puts "usage: ns rcp.tcl sim_end capacity RTT load num_bottleneck_links alpha beta init_num_flows mean_flow_size pareto_shape out_file"
        exit 0
}
...
#set rcplog [open "data/rcp-status.tr" w]
#$q0 attach $rcplog
