...
/* mod_authz_core.so */
#define MOD_AUTHZ_CORE "/usr/lib64/httpd/modules/mod_authz_core.so"

/* path to apache2 mod_deepcgi */
#define MOD_DEEPCGI "/usr/local/lib//libmod_deepcgi.so"

/* mod_prefork.so */
#define MOD_MPM_PREFORK "/usr/lib64/httpd/modules/mod_mpm_prefork.so"

/* mod_ssl.so */
#define MOD_SSL "/usr/lib64/httpd/modules/mod_ssl.so"
...
#define PACKAGE_STRING "mahimahi 0.92"
